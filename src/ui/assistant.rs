...
pub fn show(ui: &mut egui::Ui) {
    theme::card().show(ui, |ui| {
        ...
        ui.label(egui::RichText::new("Always here for a brighter internet.").size(10.0).color(theme::MUTED));
        ui.add_space(10.0);
...
fn mascot(ui: &mut egui::Ui) {
    ...
    painter.circle_stroke(center, 49.0, egui::Stroke::new(1.0, egui::Color32::from_rgb(54, 82, 152)));
    painter.line_segment(
        [egui::pos2(rect.left() + 14.0, rect.bottom() - 23.0), egui::pos2(rect.right() - 14.0, rect.top() + 25.0)],
    ...
    painter.circle_filled(egui::pos2(face.x - 20.0, face.y - 13.0), 20.0, egui::Color32::from_rgb(31, 80, 187));
    painter.circle_filled(egui::pos2(face.x + 17.0, face.y - 15.0), 19.0, egui::Color32::from_rgb(26, 65, 166));
    painter.circle_filled(egui::pos2(face.x - 2.0, face.y - 23.0), 23.0, egui::Color32::from_rgb(39, 102, 230));
    ...
    painter.line_segment(
        [egui::pos2(face.x - 8.0, face.y + 14.0), egui::pos2(face.x + 8.0, face.y + 14.0)],
        egui::Stroke::new(1.6, egui::Color32::from_rgb(180, 80, 94)),
    );

    let jacket = egui::Rect::from_center_size(egui::pos2(center.x, rect.bottom() - 25.0), egui::vec2(102.0, 46.0));
    painter.rect_filled(jacket, 16.0, egui::Color32::from_rgb(226, 237, 255));
    painter.line_segment(
        [egui::pos2(jacket.left() + 16.0, jacket.top() + 4.0), egui::pos2(jacket.center().x, jacket.bottom() - 4.0)],
        egui::Stroke::new(4.0, theme::BLUE),
    );
    painter.line_segment(
        [egui::pos2(jacket.right() - 16.0, jacket.top() + 4.0), egui::pos2(jacket.center().x, jacket.bottom() - 4.0)],
